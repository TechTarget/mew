...
exports.buildSite = function (sitename) {
  ...
  // 7. lint js & js and output warnings/errors
...
exports.releaseSite = function (sitename, message, assets, env) {
  ...
  var dirname, localPaths, remotePaths; // media server environments
  ...
  try {
    ...
    check.that('correctEnvironment', [env]);
    check.that('correctAssets', [assets]);
